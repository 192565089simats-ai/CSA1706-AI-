# EXP:1 - 8 Puzzle Problem using A* Search
...
class Node:
    ...
    def generate_child(self):
        ...
        for i, j in moves:
            # Check if move is within the puzzle
            if 0 <= i < 3 and 0 <= j < 3:
